...
namespace курсовагидро.Forms
{
    public partial class Form4 : MaterialForm
    {
        ...
        public Form4(string name, string objectType)
        {
            this.name = name;
            InitializeComponent();
            textBox1.Text = name;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (objectType == "Озера")
            {
                ...
                Lakes.ActualLake.BasinArea = Convert.ToInt32(textBox6.Text);
            ...
            else if (objectType == "Моря")
            {
                ...
                Seas.ActualSea.BasinArea = Convert.ToInt32(textBox6.Text);
